...
//
////    public Optional<String> validateSignin(RegistrationDetailDTO registrationDetailDTO) {
////        if (StringUtils.isEmpty(registrationDetailDTO.get()))
...
////    }
//
//    public Optional<String> validateFirstName(String name){
